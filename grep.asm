 ...
 65c:	89 d1                	mov    %edx,%ecx
{
 ...
 689:	0f b6 92 f0 0a 00 00 	movzbl 0xaf0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 884:	eb 1a                	jmp    8a0 <printf+0x1a0>
          s = "(null)";
 886:	bb de 0a 00 00       	mov    $0xade,%ebx
        while(*s != 0){
...
void clrsc() {
 ...
 8d7:	83 ec 1c             	sub    $0x1c,%esp
  write(fd, &c, 1);
 8da:	8d 45 f7             	lea    -0x9(%ebp),%eax
 8dd:	6a 01                	push   $0x1
 8df:	50                   	push   %eax
 8e0:	6a 01                	push   $0x1
 8e2:	c6 45 f7 1b          	movb   $0x1b,-0x9(%ebp)
 8e6:	e8 d8 fc ff ff       	call   5c3 <write>
  // ANSI escape code for clearing the screen
  putc(1, '\033'); // Escape character
  printf(1, "[2J"); // Clear entire screen
 8eb:	58                   	pop    %eax
 8ec:	5a                   	pop    %edx
 8ed:	68 e5 0a 00 00       	push   $0xae5
 8f2:	6a 01                	push   $0x1
 8f4:	e8 07 fe ff ff       	call   700 <printf>
  printf(1, "\033[H"); // Move cursor to the home position (1,1)
 8f9:	59                   	pop    %ecx
 8fa:	58                   	pop    %eax
 8fb:	68 e9 0a 00 00       	push   $0xae9
 900:	6a 01                	push   $0x1
 902:	e8 f9 fd ff ff       	call   700 <printf>
}  
...
free(void *ap)
{
 ...
 915:	a1 c0 0e 00 00       	mov    0xec0,%eax
{
 ...
 936:	73 10                	jae    948 <free+0x38>
{
 ...
 961:	5b                   	pop    %ebx
  freep = p;
 962:	a3 c0 0e 00 00       	mov    %eax,0xec0
}
 967:	5e                   	pop    %esi
 968:	5f                   	pop    %edi
 969:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 9ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9b0:	8b 3d c0 0e 00 00    	mov    0xec0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9f9:	8b 3d c0 0e 00 00    	mov    0xec0,%edi
 ...
 a22:	e8 e9 fe ff ff       	call   910 <free>
  return freep;
 a27:	a1 c0 0e 00 00       	mov    0xec0,%eax
 ...
 a54:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 a57:	a3 c0 0e 00 00       	mov    %eax,0xec0
}
 ...
 a6e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 a70:	c7 05 c0 0e 00 00 c4 	movl   $0xec4,0xec0
 a77:	0e 00 00 
    base.s.size = 0;
 a7a:	bf c4 0e 00 00       	mov    $0xec4,%edi
    base.s.ptr = freep = prevp = &base;
 a7f:	c7 05 c4 0e 00 00 c4 	movl   $0xec4,0xec4
 a86:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a89:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 a8b:	c7 05 c8 0e 00 00 00 	movl   $0x0,0xec8
 a92:	00 00 00 
    if(p->s.size >= nunits){

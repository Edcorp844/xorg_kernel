...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb ec 07 00 00       	mov    $0x7ec,%ebx
        while(*s != 0){
...
void clrsc() {
 ...
 607:	83 ec 1c             	sub    $0x1c,%esp
  write(fd, &c, 1);
 60a:	8d 45 f7             	lea    -0x9(%ebp),%eax
 60d:	6a 01                	push   $0x1
 60f:	50                   	push   %eax
 610:	6a 01                	push   $0x1
 612:	c6 45 f7 1b          	movb   $0x1b,-0x9(%ebp)
 616:	e8 d8 fc ff ff       	call   2f3 <write>
  // ANSI escape code for clearing the screen
  putc(1, '\033'); // Escape character
  printf(1, "[2J"); // Clear entire screen
 61b:	58                   	pop    %eax
 61c:	5a                   	pop    %edx
 61d:	68 f3 07 00 00       	push   $0x7f3
 622:	6a 01                	push   $0x1
 624:	e8 07 fe ff ff       	call   430 <printf>
  printf(1, "\033[H"); // Move cursor to the home position (1,1)
 629:	59                   	pop    %ecx
 62a:	58                   	pop    %eax
 62b:	68 f7 07 00 00       	push   $0x7f7
 630:	6a 01                	push   $0x1
 632:	e8 f9 fd ff ff       	call   430 <printf>
}  

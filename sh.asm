     ...
     4bd:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 88 19 00 00       	push   $0x1988
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     52d:	50                   	push   %eax
     52e:	68 88 19 00 00       	push   $0x1988
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     56e:	50                   	push   %eax
     56f:	68 80 19 00 00       	push   $0x1980
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     590:	56                   	push   %esi
     591:	68 88 19 00 00       	push   $0x1988
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     63d:	50                   	push   %eax
     63e:	68 88 19 00 00       	push   $0x1988
     ...
     e4c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e79:	0f b6 92 90 13 00 00 	movzbl 0x1390(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1074:	eb 1a                	jmp    1090 <printf+0x1a0>
          s = "(null)";
    1076:	bb 80 13 00 00       	mov    $0x1380,%ebx
        while(*s != 0){
...
void clrsc() {
    ...
    10c7:	83 ec 1c             	sub    $0x1c,%esp
  write(fd, &c, 1);
    10ca:	8d 45 f7             	lea    -0x9(%ebp),%eax
    10cd:	6a 01                	push   $0x1
    10cf:	50                   	push   %eax
    10d0:	6a 01                	push   $0x1
    10d2:	c6 45 f7 1b          	movb   $0x1b,-0x9(%ebp)
    10d6:	e8 d8 fc ff ff       	call   db3 <write>
  // ANSI escape code for clearing the screen
  putc(1, '\033'); // Escape character
  printf(1, "[2J"); // Clear entire screen
    10db:	58                   	pop    %eax
    10dc:	5a                   	pop    %edx
    10dd:	68 87 13 00 00       	push   $0x1387
    10e2:	6a 01                	push   $0x1
    10e4:	e8 07 fe ff ff       	call   ef0 <printf>
  printf(1, "\033[H"); // Move cursor to the home position (1,1)
    10e9:	59                   	pop    %ecx
    10ea:	58                   	pop    %eax
    10eb:	68 8b 13 00 00       	push   $0x138b
    10f0:	6a 01                	push   $0x1
    10f2:	e8 f9 fd ff ff       	call   ef0 <printf>
}  
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1105:	a1 04 1a 00 00       	mov    0x1a04,%eax
{
    ...
    1126:	73 10                	jae    1138 <free+0x38>
{
  ...
  freep = p;
    ...
    1151:	5b                   	pop    %ebx
  freep = p;
    1152:	a3 04 1a 00 00       	mov    %eax,0x1a04
}
    1157:	5e                   	pop    %esi
    1158:	5f                   	pop    %edi
    1159:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11a0:	8b 3d 04 1a 00 00    	mov    0x1a04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11e9:	8b 3d 04 1a 00 00    	mov    0x1a04,%edi
  ...
  return freep;
    1217:	a1 04 1a 00 00       	mov    0x1a04,%eax
    ...
    1244:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1247:	a3 04 1a 00 00       	mov    %eax,0x1a04
}
    ...
    1267:	1a 00 00 
    base.s.size = 0;
    126a:	bf 08 1a 00 00       	mov    $0x1a08,%edi
    base.s.ptr = freep = prevp = &base;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    base.s.size = 0;
    127b:	c7 05 0c 1a 00 00 00 	movl   $0x0,0x1a0c
    1282:	00 00 00 
    if(p->s.size >= nunits){

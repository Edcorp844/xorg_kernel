...
printf(int fd, const char *fmt, ...)
{
 ...
 6d4:	eb 1a                	jmp    6f0 <printf+0x1a0>
          s = "(null)";
 6d6:	bb 2f 09 00 00       	mov    $0x92f,%ebx
        while(*s != 0){
...
void clrsc() {
 ...
 727:	83 ec 1c             	sub    $0x1c,%esp
  write(fd, &c, 1);
 72a:	8d 45 f7             	lea    -0x9(%ebp),%eax
 72d:	6a 01                	push   $0x1
 72f:	50                   	push   %eax
 730:	6a 01                	push   $0x1
 732:	c6 45 f7 1b          	movb   $0x1b,-0x9(%ebp)
 736:	e8 d8 fc ff ff       	call   413 <write>
  // ANSI escape code for clearing the screen
  putc(1, '\033'); // Escape character
  printf(1, "[2J"); // Clear entire screen
 73b:	58                   	pop    %eax
 73c:	5a                   	pop    %edx
 73d:	68 36 09 00 00       	push   $0x936
 742:	6a 01                	push   $0x1
 744:	e8 07 fe ff ff       	call   550 <printf>
  printf(1, "\033[H"); // Move cursor to the home position (1,1)
 749:	59                   	pop    %ecx
 74a:	58                   	pop    %eax
 74b:	68 3a 09 00 00       	push   $0x93a
 750:	6a 01                	push   $0x1
 752:	e8 f9 fd ff ff       	call   550 <printf>
}  
...
free(void *ap)
{
 ...
 765:	a1 60 0c 00 00       	mov    0xc60,%eax
{
 ...
 786:	73 10                	jae    798 <free+0x38>
{
 ...
 7b1:	5b                   	pop    %ebx
  freep = p;
 7b2:	a3 60 0c 00 00       	mov    %eax,0xc60
}
 7b7:	5e                   	pop    %esi
 7b8:	5f                   	pop    %edi
 7b9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 7fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 800:	8b 3d 60 0c 00 00    	mov    0xc60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 849:	8b 3d 60 0c 00 00    	mov    0xc60,%edi
 ...
 872:	e8 e9 fe ff ff       	call   760 <free>
  return freep;
 877:	a1 60 0c 00 00       	mov    0xc60,%eax
 ...
 8a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 8a7:	a3 60 0c 00 00       	mov    %eax,0xc60
}
 ...
 8be:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8c0:	c7 05 60 0c 00 00 64 	movl   $0xc64,0xc60
 8c7:	0c 00 00 
    base.s.size = 0;
 8ca:	bf 64 0c 00 00       	mov    $0xc64,%edi
    base.s.ptr = freep = prevp = &base;
 8cf:	c7 05 64 0c 00 00 64 	movl   $0xc64,0xc64
 8d6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8db:	c7 05 68 0c 00 00 00 	movl   $0x0,0xc68
 8e2:	00 00 00 
    if(p->s.size >= nunits){

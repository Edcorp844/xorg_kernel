 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 00 08 00 00 	movzbl 0x800(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	eb 1a                	jmp    5c0 <printf+0x1a0>
          s = "(null)";
 5a6:	bb ef 07 00 00       	mov    $0x7ef,%ebx
        while(*s != 0){
...
void clrsc() {
 ...
 5f7:	83 ec 1c             	sub    $0x1c,%esp
  write(fd, &c, 1);
 5fa:	8d 45 f7             	lea    -0x9(%ebp),%eax
 5fd:	6a 01                	push   $0x1
 5ff:	50                   	push   %eax
 600:	6a 01                	push   $0x1
 602:	c6 45 f7 1b          	movb   $0x1b,-0x9(%ebp)
 606:	e8 d8 fc ff ff       	call   2e3 <write>
  // ANSI escape code for clearing the screen
  putc(1, '\033'); // Escape character
  printf(1, "[2J"); // Clear entire screen
 60b:	58                   	pop    %eax
 60c:	5a                   	pop    %edx
 60d:	68 f6 07 00 00       	push   $0x7f6
 612:	6a 01                	push   $0x1
 614:	e8 07 fe ff ff       	call   420 <printf>
  printf(1, "\033[H"); // Move cursor to the home position (1,1)
 619:	59                   	pop    %ecx
 61a:	58                   	pop    %eax
 61b:	68 fa 07 00 00       	push   $0x7fa
 620:	6a 01                	push   $0x1
 622:	e8 f9 fd ff ff       	call   420 <printf>
}  
...
free(void *ap)
{
 ...
 635:	a1 cc 0a 00 00       	mov    0xacc,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 cc 0a 00 00       	mov    %eax,0xacc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 cc 0a 00 00       	mov    0xacc,%eax
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 ...
 78e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf d0 0a 00 00       	mov    $0xad0,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){

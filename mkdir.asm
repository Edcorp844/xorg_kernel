 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 2c 08 00 00 	movzbl 0x82c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb 1b 08 00 00       	mov    $0x81b,%ebx
        while(*s != 0){
...
void clrsc() {
 ...
 617:	83 ec 1c             	sub    $0x1c,%esp
  write(fd, &c, 1);
 61a:	8d 45 f7             	lea    -0x9(%ebp),%eax
 61d:	6a 01                	push   $0x1
 61f:	50                   	push   %eax
 620:	6a 01                	push   $0x1
 622:	c6 45 f7 1b          	movb   $0x1b,-0x9(%ebp)
 626:	e8 d8 fc ff ff       	call   303 <write>
  // ANSI escape code for clearing the screen
  putc(1, '\033'); // Escape character
  printf(1, "[2J"); // Clear entire screen
 62b:	58                   	pop    %eax
 62c:	5a                   	pop    %edx
 62d:	68 22 08 00 00       	push   $0x822
 632:	6a 01                	push   $0x1
 634:	e8 07 fe ff ff       	call   440 <printf>
  printf(1, "\033[H"); // Move cursor to the home position (1,1)
 639:	59                   	pop    %ecx
 63a:	58                   	pop    %eax
 63b:	68 26 08 00 00       	push   $0x826
 640:	6a 01                	push   $0x1
 642:	e8 f9 fd ff ff       	call   440 <printf>
}  
...
free(void *ap)
{
 ...
 655:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 04 0b 00 00       	mov    %eax,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 04 0b 00 00       	mov    0xb04,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 ...
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 08 0b 00 00       	mov    $0xb08,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 08 0b 00 00 08 	movl   $0xb08,0xb08
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){

...
main(void)
{
  ...
  27:	0f 88 a3 00 00 00    	js     d0 <main+0xd0>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  5a:	e8 61 04 00 00       	call   4c0 <printf>
    clrsc();
  5f:	e8 2c 06 00 00       	call   690 <clrsc>
    pid = fork();
  ...
  70:	78 27                	js     99 <main+0x99>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  72:	74 38                	je     ac <main+0xac>
  ...
  78:	e8 ee 02 00 00       	call   36b <wait>
  7d:	85 c0                	test   %eax,%eax
  7f:	78 cf                	js     50 <main+0x50>
  81:	39 c3                	cmp    %eax,%ebx
  83:	74 cb                	je     50 <main+0x50>
      printf(1, "zombie!\n");
  85:	83 ec 08             	sub    $0x8,%esp
  88:	68 af 08 00 00       	push   $0x8af
  8d:	6a 01                	push   $0x1
  ...
  99:	53                   	push   %ebx
  9a:	53                   	push   %ebx
  9b:	68 83 08 00 00       	push   $0x883
  a0:	6a 01                	push   $0x1
  a2:	e8 19 04 00 00       	call   4c0 <printf>
      exit();
  a7:	e8 b7 02 00 00       	call   363 <exit>
      exec("sh", argv);
  ac:	50                   	push   %eax
  ad:	50                   	push   %eax
  ae:	68 94 0b 00 00       	push   $0xb94
  b3:	68 96 08 00 00       	push   $0x896
  b8:	e8 de 02 00 00       	call   39b <exec>
      printf(1, "init: exec sh failed\n");
  bd:	5a                   	pop    %edx
  be:	59                   	pop    %ecx
  bf:	68 99 08 00 00       	push   $0x899
  c4:	6a 01                	push   $0x1
  c6:	e8 f5 03 00 00       	call   4c0 <printf>
      exit();
  cb:	e8 93 02 00 00       	call   363 <exit>
    mknod("console", 1, 1);
  d0:	50                   	push   %eax
  d1:	6a 01                	push   $0x1
  d3:	6a 01                	push   $0x1
  d5:	68 68 08 00 00       	push   $0x868
  da:	e8 cc 02 00 00       	call   3ab <mknod>
    open("console", O_RDWR);
  df:	58                   	pop    %eax
  e0:	5a                   	pop    %edx
  e1:	6a 02                	push   $0x2
  e3:	68 68 08 00 00       	push   $0x868
  e8:	e8 b6 02 00 00       	call   3a3 <open>
  ed:	83 c4 10             	add    $0x10,%esp
  f0:	e9 38 ff ff ff       	jmp    2d <main+0x2d>
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
  f9:	66 90                	xchg   %ax,%ax
  fb:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb b8 08 00 00       	mov    $0x8b8,%ebx
        while(*s != 0){
...
void clrsc() {
 ...
 697:	83 ec 1c             	sub    $0x1c,%esp
  write(fd, &c, 1);
 69a:	8d 45 f7             	lea    -0x9(%ebp),%eax
 69d:	6a 01                	push   $0x1
 69f:	50                   	push   %eax
 6a0:	6a 01                	push   $0x1
 6a2:	c6 45 f7 1b          	movb   $0x1b,-0x9(%ebp)
 6a6:	e8 d8 fc ff ff       	call   383 <write>
  // ANSI escape code for clearing the screen
  putc(1, '\033'); // Escape character
  printf(1, "[2J"); // Clear entire screen
 6ab:	58                   	pop    %eax
 6ac:	5a                   	pop    %edx
 6ad:	68 bf 08 00 00       	push   $0x8bf
 6b2:	6a 01                	push   $0x1
 6b4:	e8 07 fe ff ff       	call   4c0 <printf>
  printf(1, "\033[H"); // Move cursor to the home position (1,1)
 6b9:	59                   	pop    %ecx
 6ba:	58                   	pop    %eax
 6bb:	68 c3 08 00 00       	push   $0x8c3
 6c0:	6a 01                	push   $0x1
 6c2:	e8 f9 fd ff ff       	call   4c0 <printf>
}  
...
free(void *ap)
{
 ...
 6d5:	a1 9c 0b 00 00       	mov    0xb9c,%eax
{
 ...
 6f6:	73 10                	jae    708 <free+0x38>
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	a3 9c 0b 00 00       	mov    %eax,0xb9c
}
 727:	5e                   	pop    %esi
 728:	5f                   	pop    %edi
 729:	5d                   	pop    %ebp
 ...
 747:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 74a:	a3 9c 0b 00 00       	mov    %eax,0xb9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 76d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 770:	8b 3d 9c 0b 00 00    	mov    0xb9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b9:	8b 3d 9c 0b 00 00    	mov    0xb9c,%edi
 ...
 7e2:	e8 e9 fe ff ff       	call   6d0 <free>
  return freep;
 7e7:	a1 9c 0b 00 00       	mov    0xb9c,%eax
 ...
 814:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 817:	a3 9c 0b 00 00       	mov    %eax,0xb9c
}
 ...
 837:	0b 00 00 
    base.s.size = 0;
 83a:	bf a0 0b 00 00       	mov    $0xba0,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 a0 0b 00 00 a0 	movl   $0xba0,0xba0
 846:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 84b:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 852:	00 00 00 
    if(p->s.size >= nunits){

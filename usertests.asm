...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12f:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "iput test ok\n");
     ...
     195:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1ac:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1c3:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1da:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1f1:	ff 35 48 5f 00 00    	pushl  0x5f48
...
00000210 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     21f:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     295:	ff 35 48 5f 00 00    	pushl  0x5f48
     ...
     2b0:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "fork failed\n");
     ...
     2c7:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    exit();
     ...
     2de:	ff 35 48 5f 00 00    	pushl  0x5f48
     ...
     2f5:	ff 35 48 5f 00 00    	pushl  0x5f48
...
00000310 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     31f:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     36a:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "openiput test ok\n");
     ...
     3aa:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "fork failed\n");
     ...
     3cc:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3e3:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "unlink failed\n");
     ...
     3fa:	ff 35 48 5f 00 00    	pushl  0x5f48
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     41f:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "open test ok\n");
     ...
     465:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "open echo failed!\n");
     ...
     47c:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     493:	ff 35 48 5f 00 00    	pushl  0x5f48
...
000004b0 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     4c1:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4f4:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "writes ok\n");
     ...
     550:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     586:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     5ba:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "small file test ok\n");
     ...
     5e8:	ff 35 48 5f 00 00    	pushl  0x5f48
     ...
     606:	ff 35 48 5f 00 00    	pushl  0x5f48
     ...
     61f:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     636:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "read failed\n");
     ...
     64d:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "unlink small failed\n");
     ...
     664:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     67b:	ff 35 48 5f 00 00    	pushl  0x5f48
...
00000690 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     6a1:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "big files ok\n");
     ...
     795:	ff 35 48 5f 00 00    	pushl  0x5f48
     ...
     7b3:	ff 35 48 5f 00 00    	pushl  0x5f48
     ...
     7ca:	ff 35 48 5f 00 00    	pushl  0x5f48
     ...
     7e3:	ff 35 48 5f 00 00    	pushl  0x5f48
     ...
     7fe:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     815:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     82c:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "unlink big failed\n");
     ...
     843:	ff 35 48 5f 00 00    	pushl  0x5f48
     ...
     868:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     875:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     906:	ff 35 48 5f 00 00    	pushl  0x5f48
...
00000920 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     92f:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     995:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "mkdir failed\n");
     ...
     9ac:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     9c3:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9da:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9f1:	ff 35 48 5f 00 00    	pushl  0x5f48
...
00000a10 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     a1f:	ff 35 48 5f 00 00    	pushl  0x5f48
     a25:	e8 b6 30 00 00       	call   3ae0 <printf>
  if(exec("echo", echoargv) < 0){
     a2a:	5a                   	pop    %edx
     a2b:	59                   	pop    %ecx
     a2c:	68 4c 5f 00 00       	push   $0x5f4c
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a4b:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    2dd8:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2de4:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3039:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    30b6:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    30d0:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    3102:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    3122:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    3139:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    3150:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    3167:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    317e:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    3195:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    31ac:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    31c8:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    31df:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    3208:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    3213:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "validate ok\n");
    ...
    3281:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    32a3:	ff 35 48 5f 00 00    	pushl  0x5f48
...
000032c0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    32cf:	ff 35 48 5f 00 00    	pushl  0x5f48
  ...
  printf(stdout, "bss test ok\n");
    ...
    32fb:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    3313:	ff 35 48 5f 00 00    	pushl  0x5f48
...
00003330 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    33aa:	ff 35 48 5f 00 00    	pushl  0x5f48
    args[MAXARG-1] = 0;
    ...
    33d7:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    3407:	ff 35 48 5f 00 00    	pushl  0x5f48
    ...
    341e:	ff 35 48 5f 00 00    	pushl  0x5f48
...
00003700 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3704:	69 05 44 5f 00 00 0d 	imul   $0x19660d,0x5f44,%eax
    370b:	66 19 00 
    370e:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3713:	a3 44 5f 00 00       	mov    %eax,0x5f44
}
    3718:	c3                   	ret    
    ...
    3a3c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    3a69:	0f b6 92 30 56 00 00 	movzbl 0x5630(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3c64:	eb 1a                	jmp    3c80 <printf+0x1a0>
          s = "(null)";
    3c66:	bb 1e 56 00 00       	mov    $0x561e,%ebx
        while(*s != 0){
...
void clrsc() {
    ...
    3cb4:	55                   	push   %ebp
    3cb5:	89 e5                	mov    %esp,%ebp
    3cb7:	83 ec 1c             	sub    $0x1c,%esp
  write(fd, &c, 1);
    3cba:	8d 45 f7             	lea    -0x9(%ebp),%eax
    3cbd:	6a 01                	push   $0x1
    3cbf:	50                   	push   %eax
    3cc0:	6a 01                	push   $0x1
    3cc2:	c6 45 f7 1b          	movb   $0x1b,-0x9(%ebp)
    3cc6:	e8 d8 fc ff ff       	call   39a3 <write>
  // ANSI escape code for clearing the screen
  putc(1, '\033'); // Escape character
  printf(1, "[2J"); // Clear entire screen
    3ccb:	58                   	pop    %eax
    3ccc:	5a                   	pop    %edx
    3ccd:	68 25 56 00 00       	push   $0x5625
    3cd2:	6a 01                	push   $0x1
    3cd4:	e8 07 fe ff ff       	call   3ae0 <printf>
  printf(1, "\033[H"); // Move cursor to the home position (1,1)
    3cd9:	59                   	pop    %ecx
    3cda:	58                   	pop    %eax
    3cdb:	68 29 56 00 00       	push   $0x5629
    3ce0:	6a 01                	push   $0x1
    3ce2:	e8 f9 fd ff ff       	call   3ae0 <printf>
}  
    3ce7:	83 c4 10             	add    $0x10,%esp
    3cea:	c9                   	leave  
    3ceb:	c3                   	ret    
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3cf5:	a1 e0 5f 00 00       	mov    0x5fe0,%eax
{
    ...
    3d16:	73 10                	jae    3d28 <free+0x38>
{
  ...
  freep = p;
    ...
    3d41:	5b                   	pop    %ebx
  freep = p;
    3d42:	a3 e0 5f 00 00       	mov    %eax,0x5fe0
}
    3d47:	5e                   	pop    %esi
    3d48:	5f                   	pop    %edi
    3d49:	5d                   	pop    %ebp
  ...
  freep = p;
    3d6a:	a3 e0 5f 00 00       	mov    %eax,0x5fe0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d90:	8b 3d e0 5f 00 00    	mov    0x5fe0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3dd9:	8b 3d e0 5f 00 00    	mov    0x5fe0,%edi
  ...
  return freep;
    3e07:	a1 e0 5f 00 00       	mov    0x5fe0,%eax
    ...
    3e34:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3e37:	a3 e0 5f 00 00       	mov    %eax,0x5fe0
}
    ...
    base.s.ptr = freep = prevp = &base;
    3e50:	c7 05 e0 5f 00 00 e4 	movl   $0x5fe4,0x5fe0
    3e57:	5f 00 00 
    base.s.size = 0;
    3e5a:	bf e4 5f 00 00       	mov    $0x5fe4,%edi
    base.s.ptr = freep = prevp = &base;
    3e5f:	c7 05 e4 5f 00 00 e4 	movl   $0x5fe4,0x5fe4
    3e66:	5f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e69:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3e6b:	c7 05 e8 5f 00 00 00 	movl   $0x0,0x5fe8
    3e72:	00 00 00 
    if(p->s.size >= nunits){

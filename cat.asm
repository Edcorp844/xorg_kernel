...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb b0 08 00 00       	mov    $0x8b0,%ebx
        while(*s != 0){
...
void clrsc() {
 ...
 6a7:	83 ec 1c             	sub    $0x1c,%esp
  write(fd, &c, 1);
 6aa:	8d 45 f7             	lea    -0x9(%ebp),%eax
 6ad:	6a 01                	push   $0x1
 6af:	50                   	push   %eax
 6b0:	6a 01                	push   $0x1
 6b2:	c6 45 f7 1b          	movb   $0x1b,-0x9(%ebp)
 6b6:	e8 d8 fc ff ff       	call   393 <write>
  // ANSI escape code for clearing the screen
  putc(1, '\033'); // Escape character
  printf(1, "[2J"); // Clear entire screen
 6bb:	58                   	pop    %eax
 6bc:	5a                   	pop    %edx
 6bd:	68 b7 08 00 00       	push   $0x8b7
 6c2:	6a 01                	push   $0x1
 6c4:	e8 07 fe ff ff       	call   4d0 <printf>
  printf(1, "\033[H"); // Move cursor to the home position (1,1)
 6c9:	59                   	pop    %ecx
 6ca:	58                   	pop    %eax
 6cb:	68 bb 08 00 00       	push   $0x8bb
 6d0:	6a 01                	push   $0x1
 6d2:	e8 f9 fd ff ff       	call   4d0 <printf>
}  
...
free(void *ap)
{
 ...
 6e5:	a1 e0 0b 00 00       	mov    0xbe0,%eax
{
 ...
 706:	73 10                	jae    718 <free+0x38>
{
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 e0 0b 00 00       	mov    %eax,0xbe0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 77d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 780:	8b 3d e0 0b 00 00    	mov    0xbe0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c9:	8b 3d e0 0b 00 00    	mov    0xbe0,%edi
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	a1 e0 0b 00 00       	mov    0xbe0,%eax
 ...
 824:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 827:	a3 e0 0b 00 00       	mov    %eax,0xbe0
}
 ...
 847:	0b 00 00 
    base.s.size = 0;
 84a:	bf e4 0b 00 00       	mov    $0xbe4,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 e4 0b 00 00 e4 	movl   $0xbe4,0xbe4
 856:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 85b:	c7 05 e8 0b 00 00 00 	movl   $0x0,0xbe8
 862:	00 00 00 
    if(p->s.size >= nunits){

 ...
 34c:	89 d1                	mov    %edx,%ecx
{
 ...
 379:	0f b6 92 a8 07 00 00 	movzbl 0x7a8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 574:	eb 1a                	jmp    590 <printf+0x1a0>
          s = "(null)";
 576:	bb 98 07 00 00       	mov    $0x798,%ebx
        while(*s != 0){
...
void clrsc() {
 ...
 5c7:	83 ec 1c             	sub    $0x1c,%esp
  write(fd, &c, 1);
 5ca:	8d 45 f7             	lea    -0x9(%ebp),%eax
 5cd:	6a 01                	push   $0x1
 5cf:	50                   	push   %eax
 5d0:	6a 01                	push   $0x1
 5d2:	c6 45 f7 1b          	movb   $0x1b,-0x9(%ebp)
 5d6:	e8 d8 fc ff ff       	call   2b3 <write>
  // ANSI escape code for clearing the screen
  putc(1, '\033'); // Escape character
  printf(1, "[2J"); // Clear entire screen
 5db:	58                   	pop    %eax
 5dc:	5a                   	pop    %edx
 5dd:	68 9f 07 00 00       	push   $0x79f
 5e2:	6a 01                	push   $0x1
 5e4:	e8 07 fe ff ff       	call   3f0 <printf>
  printf(1, "\033[H"); // Move cursor to the home position (1,1)
 5e9:	59                   	pop    %ecx
 5ea:	58                   	pop    %eax
 5eb:	68 a3 07 00 00       	push   $0x7a3
 5f0:	6a 01                	push   $0x1
 5f2:	e8 f9 fd ff ff       	call   3f0 <printf>
}  
...
free(void *ap)
{
 ...
 605:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;

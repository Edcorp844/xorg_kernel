...
printf(int fd, const char *fmt, ...)
{
 ...
 884:	eb 1a                	jmp    8a0 <printf+0x1a0>
          s = "(null)";
 886:	bb f2 0a 00 00       	mov    $0xaf2,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 915:	a1 5c 0e 00 00       	mov    0xe5c,%eax
{
 ...
 936:	73 10                	jae    948 <free+0x38>
{
 ...
 961:	5b                   	pop    %ebx
  freep = p;
 962:	a3 5c 0e 00 00       	mov    %eax,0xe5c
}
 967:	5e                   	pop    %esi
 968:	5f                   	pop    %edi
 969:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 9ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9b0:	8b 3d 5c 0e 00 00    	mov    0xe5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9f9:	8b 3d 5c 0e 00 00    	mov    0xe5c,%edi
 ...
 a22:	e8 e9 fe ff ff       	call   910 <free>
  return freep;
 a27:	a1 5c 0e 00 00       	mov    0xe5c,%eax
 ...
 a54:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 a57:	a3 5c 0e 00 00       	mov    %eax,0xe5c
}
 ...
 a6e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 a70:	c7 05 5c 0e 00 00 60 	movl   $0xe60,0xe5c
 a77:	0e 00 00 
    base.s.size = 0;
 a7a:	bf 60 0e 00 00       	mov    $0xe60,%edi
    base.s.ptr = freep = prevp = &base;
 a7f:	c7 05 60 0e 00 00 60 	movl   $0xe60,0xe60
 a86:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a89:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 a8b:	c7 05 64 0e 00 00 00 	movl   $0x0,0xe64
 a92:	00 00 00 
    if(p->s.size >= nunits){
